                ...
                <div class="card bg-success text-white shadow">
                    ...
                    <div class = "col-lg-10">
                        <c:forEach items="${task}" var="title">
                            ...
                            <div class="card mb-4 py-3 border-left-${title.color}">
                                <div class="card-body">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">${title.userAssigned}
                                        | <strong>Dodano:</strong> ${title.creationDate} |
                                ...
                                <div class="col-sm-12">
                                    <div class="card-body ">
                                        <a href='<c:url value="/editTask/${title.id}"/>'
                                           class="btn-right btn btn-primary float-right" role="button">Edytuj</a>
